...
figCont.show_contour(label['VLA'][0], colors='red', levels=sigma_contour_array(sigma_VLA), linewidths=1.5, layer='fg_cont')
figCont.show_contour(label['cont'][0], colors="white", levels=sigma_contour_CARMA(sigma_cont), linewidths=2, layer='mol')
